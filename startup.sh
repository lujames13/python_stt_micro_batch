...
echo "接下來，請手動完成以下步驟:"
echo ""
echo "1. 執行 gcloud 身份驗證 (如果尚未登入):"
echo "   gcloud auth login"
echo ""
echo "2. 如需應用預設身份驗證，請執行:"
echo "   gcloud auth application-default login"
echo ""
echo "3. 確保激活正確的 conda 環境:"
echo "   conda activate gemini-stt"
echo ""
echo "4. 確保在正確的專案目錄中:"
echo "   cd $(pwd)"
echo ""
echo "5. 啟動 gradio_test:"
echo "   python3 gradio-test.py -l cmn-Hant-TW -project $PROJECT_ID -location $LOCATION"
echo ""
echo "完整命令組合 (複製貼上執行):"
echo "   conda activate gemini-stt && cd $(pwd) && python3 gradio-test.py -l cmn-Hant-TW -project $PROJECT_ID -location $LOCATION"
echo ""
echo "注意: 如果遇到身份驗證問題，請確保您已授予足夠的權限範圍。"